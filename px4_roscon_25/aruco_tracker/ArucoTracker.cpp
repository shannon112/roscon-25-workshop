// ============================================================================
// ORIGINAL VERSION - ArucoTracker.cpp
// ============================================================================
...
// 				   std::bind(&ArucoTrackerNode::local_position_callback, this, std::placeholders::_1));
...
// void ArucoTrackerNode::local_position_callback(const px4_msgs::msg::VehicleLocalPosition::SharedPtr msg)
// {
// 	// Extract distance to ground
// 	_distance_to_ground = msg->dist_bottom;
// 	// RCLCPP_INFO(get_logger(), "Distance to ground: %f", _distance_to_ground);
// }
...
// 				_calculated_marker_size = (pixel_width / focal_length) * _distance_to_ground;
// 				// RCLCPP_INFO(get_logger(), "Calculated marker size: %f", _calculated_marker_size);
...
// void ArucoTrackerNode::annotate_image(cv_bridge::CvImagePtr image, const cv::Vec3d& target)
// {
// 	// Annotate the image with the target position and marker size and calculated marker size
// 	std::ostringstream stream;
// 	stream << std::fixed << std::setprecision(2);
// 	stream << "X: "  << target[0] << " Y: " << target[1]  << " Z: " << target[2] << " M: " << _calculated_marker_size;
// 	std::string text_xyz = stream.str();
