// ============================================================================
// ORIGINAL VERSION - CustomModeExecutor_v2.cpp
// ============================================================================
#include "CustomModeExecutor_v2.hpp"

using CustomModeWithExecutor = px4_ros2::NodeWithModeExecutor<CustomModeExecutor, CustomWaypoints, PrecisionLand>;
    ...
    switch (state) {
        ...
        case State::CustomWaypoints:
            scheduleMode(ownedMode().id(), [this](px4_ros2::Result result) {
                ...
                switchToState(State::PrecisionLand, result);
            });
            break;
